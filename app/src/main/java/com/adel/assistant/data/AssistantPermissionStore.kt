...
object AssistantPermissionStore {
    private val defaults=mapOf("navigation" to AssistantPermission.AUTO,"tasks" to AssistantPermission.AUTO,"calculations" to AssistantPermission.AUTO,"files_read" to AssistantPermission.ASK,"data_read" to AssistantPermission.AUTO,"memory_write" to AssistantPermission.AUTO,"finance_write" to AssistantPermission.ASK,"delete" to AssistantPermission.ASK,"online_ai" to AssistantPermission.AUTO)
